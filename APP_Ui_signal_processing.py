...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_1.setMaximumSize(QtCore.QSize(16777215, 35))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.slider_scale = QtWidgets.QSlider(QtCore.Qt.Horizontal, self)
        self.slider_scale.setRange(2, 64)
        self.slider_scale.setSingleStep(1)
        self.slider_scale.setPageStep(2)
        self.slider_scale.setMinimumSize(QtCore.QSize(200, 35))
        self.slider_scale.setMaximumSize(QtCore.QSize(360, 35))
        self.slider_scale.setFont(font)
        ...
        self.pushButton_3.setStyleSheet('background-color: rgb(255, 193, 99);border-radius:25px;border:5px groove gray;border-style:outset;')
